...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Tunanganku", "Aku ada pertanyaan nih buat kamu", "question").then(function () {
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  icon: 'question',
                  input: 'range',
                  inputLabel: 'Antara 1 - 1.000.000.000 ya',
                  inputAttributes: {
                    min: 1,
                    max: 1.000.000.000,
                    step: 1
                  ...
                  val = e.value
                  Swal.fire(`Makasih ya sudah sayang ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} juga kangen ${nama} , makasihhh yaa`).then(function () {
                          Swal.fire('Terakhir deh sayang').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah gih')
                          })
                        })
